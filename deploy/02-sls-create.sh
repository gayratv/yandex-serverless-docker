...
# разрешить публичный вызов
echo "yc serverless container allow-unauthenticated-invoke --id ${CONTAINER_ID}"
yc serverless container allow-unauthenticated-invoke --id ${CONTAINER_ID}